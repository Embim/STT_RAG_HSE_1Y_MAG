...
export class ApiService {
  ...
  ingestYoutube(body: { url: string; export_txt?: boolean; export_json?: boolean; keep_video?: boolean; keep_audio?: boolean }): Observable<JobAccepted> {
    return this.http.post<JobAccepted>(`${this.base}/ingest`, body);
  }

  ingestUpload(files: File[], opts: { export_txt?: boolean; export_json?: boolean; keep_audio?: boolean }): Observable<HttpEvent<JobAccepted>> {
